...
//HANDLING ALERTS	
	...
	/**
	 * This alert will get test from the alert
...
//HANDLING FRAMES
	 ...
	 * @param nameOrId
	 */
	public static void switchToFrames(String nameOrId) {
		try {
...
//JAVA SCRIPT EXECUTOR	
	/**
	 * This method will click on element using JSExecutor
	 * @param element
	 */
...
//TAKE A SCREENSHOT	
	 ...
	 * @return
	 */
	public static byte[] takeSreenshot(String fileName) {
		Date date = new Date();
...
//RADIO BUTTON
	...
	public static void clickRadio(List<WebElement> elements, String radioText) {
		for(WebElement element: elements){
			if(element.getText().contentEquals(radioText)) {
				element.click();
				break;
			}
		}
